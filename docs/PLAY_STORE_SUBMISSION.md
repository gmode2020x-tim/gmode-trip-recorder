...
- [x] Version name/code: `2.1.0` / `20100`
...
- [ ] Upload `GMODE-Trip-Recorder-v2.1.0-play.aab` to an internal test track first
...
3. Production: use staged rollout, monitor Android vitals, and retain v2.1.0 artifacts/checksums.
...
Adds authenticated Home Assistant phone-health logs, periodic diagnostics, revisioned notices and update metadata, bounded automatic-recording settings, and acknowledged sync/re-arm commands. Includes the v2 cockpit, scene-matched 3D vehicles, combined pitch/roll attitude, radial course, stability alerts, 13 gauges, editable app controls, hybrid automatic recording, four exports, and offline HA catch-up.
