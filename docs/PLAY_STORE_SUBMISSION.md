...
- [x] Version name/code: `2.1.8` / `20108`
...
- [ ] Upload `GMODE-Trip-Recorder-v2.1.8-play.aab` to an internal test track first
...
3. Production: use staged rollout, monitor Android vitals, and retain v2.1.8 artifacts/checksums.
