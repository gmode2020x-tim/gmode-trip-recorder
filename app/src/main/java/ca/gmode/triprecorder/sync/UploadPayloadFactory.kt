        ...
        points.forEach { point ->
            pointsJson.put(
                JSONObject()
                    ...
                    .putNullable("accelerationPeakXMs2", point.accelerationPeakXMs2)
                    .putNullable("accelerationPeakYMs2", point.accelerationPeakYMs2)
                    .putNullable("accelerationPeakZMs2", point.accelerationPeakZMs2)
